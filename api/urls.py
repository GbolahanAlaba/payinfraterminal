...
from api.views import ProcessPaymentAPIView, VerifyTransactionView, MobileTopupAPIView, BillPaymentAPIView
...
urlpatterns = [
    ...
    path("bills-payment/", BillPaymentAPIView.as_view(), name="bills"),
